...
function Footer() {
  return (
    <div className='text-black flex gap-5 w-full h-screen bg-zinc-400 p-20'>
        <div className="w-1/2 h-full flex flex-col justify-between font-['Founders_Grotesk_X-Condensed']">
            <div className="heading">
                <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-4'>Eye-</h1>
                <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-4'>Opening</h1>
            </div>
                 <div>
        ...
        <div className="w-1/2 mr-16">
            <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-4 font-["Founders_Grotesk_X-Condensed"]'>Presentations</h1>
            ...
            <div className="block text-xl mb-[4vh] mt-[4vh]">L:</div>
            <div className="dets font-['Neue_Montreal'] mt-10">
                <a className='underline block text-l font-light' href="">202-1965 W 4th Ave</a>
                <a className='underline block text-l font-light' href="">Vancover,Canada</a>    
            </div>
            <div className="dets font-['Neue_Montreal'] mt-10">
                <a className='underline block text-l font-light' href="">30 Chukarina St</a>
                <a className='underline block text-l font-light' href="">Lviv,Ukraine</a>
            </div>
            <div className="block text-xl mb-[4vh] mt-[4vh]">E:</div>
            <div className="dets font-['Neue_Montreal'] mt-10">
                <a className='underline block text-l font-light' href="">hello@ochi.design</a>   
            </div>
