...
function Footer() {
  return (
    <div className='text-black flex flex-col md:flex-row gap-8 md:gap-5 w-full min-h-[60vh] bg-zinc-400 px-6 md:px-12 lg:px-20 py-12 md:py-16 lg:py-20'>
        <div className="w-full md:w-1/2 h-full flex flex-col justify-between font-['Founders_Grotesk_X-Condensed']">
            <div className="heading">
                <h1 className='text-[14vw] md:text-[8vw] lg:text-[6vw] font-semibold uppercase leading-none -mb-4'>Eye-</h1>
                <h1 className='text-[14vw] md:text-[8vw] lg:text-[6vw] font-semibold uppercase leading-none -mb-4'>Opening</h1>
            </div>
                 <div>
        ...
        <div className="w-full md:w-1/2 md:mr-16">
            <h1 className='text-[14vw] md:text-[8vw] lg:text-[6vw] font-semibold uppercase leading-none -mb-4 font-["Founders_Grotesk_X-Condensed"]'>Presentations</h1>
            ...
            <div className="block text-lg md:text-xl mb-[3vh] md:mb-[4vh] mt-[3vh] md:mt-[4vh]">L:</div>
            <div className="dets font-['Neue_Montreal'] mt-10">
                <a className='underline block text-base md:text-lg font-light' href="">202-1965 W 4th Ave</a>
                <a className='underline block text-base md:text-lg font-light' href="">Vancover,Canada</a>    
            </div>
            <div className="dets font-['Neue_Montreal'] mt-10">
                <a className='underline block text-base md:text-lg font-light' href="">30 Chukarina St</a>
                <a className='underline block text-base md:text-lg font-light' href="">Lviv,Ukraine</a>
            </div>
            <div className="block text-lg md:text-xl mb-[3vh] md:mb-[4vh] mt-[3vh] md:mt-[4vh]">E:</div>
            <div className="dets font-['Neue_Montreal'] mt-10">
                <a className='underline block text-base md:text-lg font-light' href="">hello@ochi.design</a>   
            </div>
