            ...
            <div className="absolute flex gap-10 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[90%]">
                <div className="flex items-center justify-center w-[200px] h-[200px] rounded-full bg-zinc-100">
                   <div className="relative w-2/3 h-2/3 rounded-full bg-zinc-900">
                        <div className='text-[18px] absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] font-semibold'>PLAY</div>
                ...
                <div className="flex items-center justify-center w-[200px] h-[200px] rounded-full bg-zinc-100">
                    <div className="relative w-2/3 h-2/3 rounded-full bg-zinc-900">
                        <div className='text-[18px] absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] font-semibold'>PLAY</div>
                        <circle style={{transform: `translate(-50%, -50%) rotate(${rotate}deg)`}} className="line  absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] w-full h-10">
                          <div className="m-[2px] w-[18px] h-[18px] rounded-full bg-zinc-100"></div>
                        </circle>
                   </div>
                </div>
